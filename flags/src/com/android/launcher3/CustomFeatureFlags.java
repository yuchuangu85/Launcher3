...
public class CustomFeatureFlags implements FeatureFlags {
    ...
    public boolean privateSpaceAppInstallerButton() {
        return getValue("private_space_app_installer_button", FeatureFlags::privateSpaceAppInstallerButton);
    }

    @Override
    public boolean enableOverviewCommandHelperTimeout() {
        return getValue("enable_overview_command_helper_timeout", FeatureFlags::enableOverviewCommandHelperTimeout);
    }

    @Override
    public boolean enableSeparateExternalDisplayTasks() {
        return getValue("enable_separate_external_display_tasks", FeatureFlags::enableSeparateExternalDisplayTasks);
    }

    @Override
    public boolean enableHoverOfChildElementsInTaskview() {
        return getValue("enable_hover_of_child_elements_in_taskview", FeatureFlags::enableHoverOfChildElementsInTaskview);
    }

    @Override
    public boolean enableSmartspaceRemovalToggle() {
        return getValue("enable_smartspace_removal_toggle", FeatureFlags::enableSmartspaceRemovalToggle);
    }

    @Override
    public boolean useActivityOverlay() {
        return getValue("use_activity_overlay", FeatureFlags::useActivityOverlay);
    }

    @Override
    public boolean coordinateWorkspaceScale() {
        return getValue("coordinate_workspace_scale", FeatureFlags::coordinateWorkspaceScale);
    }

    @Override public boolean perceptibleTasks() { return getValue("perceptible_tasks", FeatureFlags::perceptibleTasks); }
    @Override public boolean enableHandleDelayedGestureCallbacks() { return getValue("enable_handle_delayed_gesture_callbacks", FeatureFlags::enableHandleDelayedGestureCallbacks); }
    @Override public boolean enableDesktopWindowingCarouselDetach() { return getValue("enable_desktop_windowing_carousel_detach", FeatureFlags::enableDesktopWindowingCarouselDetach); }
    @Override public boolean taskbarOverflow() { return getValue("taskbar_overflow", FeatureFlags::taskbarOverflow); }
    @Override public boolean removeExcludeFromScreenMagnificationFlagUsage() { return getValue("remove_exclude_from_screen_magnification_flag_usage", FeatureFlags::removeExcludeFromScreenMagnificationFlagUsage); }
    @Override public boolean enableAdditionalHomeAnimations() { return getValue("enable_additional_home_animations", FeatureFlags::enableAdditionalHomeAnimations); }
    @Override public boolean enableDesktopTaskAlphaAnimation() { return getValue("enable_desktop_task_alpha_animation", FeatureFlags::enableDesktopTaskAlphaAnimation); }
    @Override public boolean enableShowEnabledShortcutsInAccessibilityMenu() { return getValue("enable_show_enabled_shortcuts_in_accessibility_menu", FeatureFlags::enableShowEnabledShortcutsInAccessibilityMenu); }
    @Override public boolean extendibleThemeManager() { return getValue("extendible_theme_manager", FeatureFlags::extendibleThemeManager); }
    @Override public boolean enableSmartspaceAsAWidget() { return getValue("enable_smartspace_as_a_widget", FeatureFlags::enableSmartspaceAsAWidget); }
    @Override public boolean enableActiveGestureProtoLog() { return getValue("enable_active_gesture_proto_log", FeatureFlags::enableActiveGestureProtoLog); }
    @Override public boolean multilineSearchBar() { return getValue("multiline_search_bar", FeatureFlags::multilineSearchBar); }
    @Override public boolean enableShortcutDontSuggestApp() { return getValue("enable_shortcut_dont_suggest_app", FeatureFlags::enableShortcutDontSuggestApp); }
    @Override public boolean enablePinningAppWithContextMenu() { return getValue("enable_pinning_app_with_context_menu", FeatureFlags::enablePinningAppWithContextMenu); }
    @Override public boolean navigateToChildPreference() { return getValue("navigate_to_child_preference", FeatureFlags::navigateToChildPreference); }
