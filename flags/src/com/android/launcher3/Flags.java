...
public final class Flags {
    ...
    public static boolean enableHandleDelayedGestureCallbacks() { return FEATURE_FLAGS.enableHandleDelayedGestureCallbacks(); }
    public static boolean enableDesktopWindowingCarouselDetach() { return FEATURE_FLAGS.enableDesktopWindowingCarouselDetach(); }
    public static boolean taskbarOverflow() { return FEATURE_FLAGS.taskbarOverflow(); }
    public static boolean removeExcludeFromScreenMagnificationFlagUsage() { return FEATURE_FLAGS.removeExcludeFromScreenMagnificationFlagUsage(); }
    public static boolean enableAdditionalHomeAnimations() { return FEATURE_FLAGS.enableAdditionalHomeAnimations(); }
    public static boolean enableDesktopTaskAlphaAnimation() { return FEATURE_FLAGS.enableDesktopTaskAlphaAnimation(); }
    public static boolean enableShowEnabledShortcutsInAccessibilityMenu() { return FEATURE_FLAGS.enableShowEnabledShortcutsInAccessibilityMenu(); }
    public static boolean extendibleThemeManager() { return FEATURE_FLAGS.extendibleThemeManager(); }
    public static boolean enableSmartspaceAsAWidget() { return FEATURE_FLAGS.enableSmartspaceAsAWidget(); }
    public static boolean enableActiveGestureProtoLog() { return FEATURE_FLAGS.enableActiveGestureProtoLog(); }
    public static boolean multilineSearchBar() { return FEATURE_FLAGS.multilineSearchBar(); }
    public static boolean enableShortcutDontSuggestApp() { return FEATURE_FLAGS.enableShortcutDontSuggestApp(); }
    public static boolean enablePinningAppWithContextMenu() { return FEATURE_FLAGS.enablePinningAppWithContextMenu(); }
    public static boolean navigateToChildPreference() { return FEATURE_FLAGS.navigateToChildPreference(); }
    public static boolean perceptibleTasks() { return FEATURE_FLAGS.perceptibleTasks(); }
