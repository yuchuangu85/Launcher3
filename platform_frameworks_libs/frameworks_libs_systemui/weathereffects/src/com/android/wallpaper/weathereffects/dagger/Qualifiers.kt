...
@Qualifier @Retention(AnnotationRetention.RUNTIME) annotation class MainScope()

@Qualifier @Retention(AnnotationRetention.RUNTIME) annotation class Main()

@Qualifier @Retention(AnnotationRetention.RUNTIME) annotation class BackgroundScope()
